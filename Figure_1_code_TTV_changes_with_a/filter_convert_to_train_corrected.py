...
# read data
with open(cwd + '/TTV_files_ttv/kepler88_obs_2016_para2013_7_19_forDiff_corrected_9_2.pkl', 'rb') as fileo:
    try:
        while True:
...
file_filtered = open(cwd + '/TTV_files_ttv/kepler88_obs_2016_para2013_Data_7_19_forDiff_corrected_9_2.pkl', 'wb')

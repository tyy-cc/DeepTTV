...
void System::Simulate() {
  ...
  int first_simu = 0; //
  long double init_dist[bodies.size()];
  ...
  std::fstream transit_output;
  transit_output.open(system_name + ".txt", std::fstream::out);

  if (!is_continued_sys)
    data_json.push_back(OutputDataJson());

// KOI142 stellar_radius from different source 
  long double radius_list[2] = {0.0041714691, 0.004092411}; //Weiss et. al., 2020; Nesvorny et al., 2013
  long double stellar_radius = radius_list[1]; //0.0041714691;

// KOI142 observed ttv by Nesvorny et. al., 2013, {transit number, ttv in min}
std::unordered_map<long double, long double> obs_ttv_inter = {
                                                              {1.0, 10.925508555555552}, {2.0, 10.9257168888889}, {3.0, 10.920023444444439}, {5.0, 21.843100444444445}, {6.0, 10.915579000000008}, 
                                                              {7.0, 10.91738355555556}, {8.0, 10.913980777777738}, {9.0, 10.917037333333354}, {11.0, 21.825114333333346}, {12.0, 10.910717888888882}, 
                                                              {13.0, 10.909605777777784}, {14.0, 10.910716888888885}, {15.0, 10.909259555555565}, {16.0, 10.910439111111089}, {17.0, 10.908147444444438}, 
                                                              {18.0, 10.912592888888895}, {19.0, 10.908564111111104}, {20.0, 10.917105777777806}, {22.0, 21.838170888888897}, {23.0, 10.922105777777801}, 
                                                              {25.0, 21.86803199999997}, {26.0, 10.95044011111105}, {27.0, 10.948425222222227}, {28.0, 10.964814111111139}, {29.0, 10.964467888888862}, 
                                                              {30.0, 10.98120300000005}, {31.0, 10.983564111111093}, {32.0, 10.99349566666666}, {33.0, 10.996341888888878}, {34.0, 11.006828000000041}, 
                                                              {35.0, 11.015231777777785}, {36.0, 11.010508555555532}, {37.0, 11.027036333333342}, {38.0, 11.008565111111125}, {39.0, 11.036480777777797}, 
                                                              {40.0, 11.008008555555477}, {41.0, 11.032384555555552}, {42.0, 11.001758555555682}, {43.0, 11.02536966666662}, {44.0, 10.992453999999952}, 
                                                              {45.0, 11.012314111111209}, {46.0, 10.980369666666547}, {47.0, 11.000787333333278}, {48.0, 10.962661333333358}, {49.0, 10.981133555555516}, 
                                                              {50.0, 10.949120666666772}, {51.0, 10.963494666666634}, {52.0, 10.93911966666667}, {53.0, 10.945231777777735}, {54.0, 10.92759188888897}, 
                                                              {57.0, 32.78687388888886}, {58.0, 10.915577999999982}, {59.0, 10.919606777777858}, {60.0, 10.913425222222145}, {61.0, 10.913841888888896}, 
                                                              {62.0, 10.918634555555627}, {63.0, 10.914258555555534}, {64.0, 10.91606411111104}, {65.0, 10.915995666666731}, {66.0, 10.917314111111068}, 
                                                              {67.0, 10.913980777777851}, {68.0, 10.91745400000002}, {69.0, 10.918008555555502}, {70.0, 10.916550222222213}, {71.0, 10.922662333333392}, 
                                                              {72.0, 10.921480777777788}, {73.0, 10.918772444444471}, {74.0, 10.923842888888771}, {75.0, 10.92168911111105}, {76.0, 10.922661333333394}, 
                                                              {77.0, 10.92877344444446}, {78.0, 10.92266133333328}, {79.0, 10.933008555555602}, {80.0, 10.922662333333278}, {81.0, 10.936480777777774}, 
                                                              {82.0, 10.93995300000006}, {83.0, 10.948009555555586}, {84.0, 10.943425222222118}, {85.0, 10.95321688888896}, {87.0, 21.925115333333338}, 
                                                              {88.0, 10.958911333333276}, {89.0, 10.980579000000034}, {90.0, 10.9760641111111}, {92.0, 21.98205977777775}, {93.0, 11.003633555555552}, 
                                                              {94.0, 10.994953000000123}, {96.0, 22.01678199999992}, {97.0, 11.009466888888937}, {98.0, 11.012592888889003}, {99.0, 11.005300222222104}, 
                                                              {100.0, 11.013911333333454}, {101.0, 10.999606777777672}, {102.0, 11.009814111110927}, {103.0, 10.987383555555652}, {104.0, 11.001690111111202}, 
                                                              {105.0, 10.978564111111154}, {106.0, 10.986897444444367}, {109.0, 32.876109999999926}, {110.0, 10.955717888889012}, {111.0, 10.931966888888837}, 
                                                              {112.0, 10.943703000000141}, {113.0, 10.916551222222097}, {114.0, 10.93071688888881}, {115.0, 10.909883555555552}, {116.0, 10.91620399999988}, 
                                                              {117.0, 10.908286333333308}, {119.0, 21.821851444444746}, {121.0, 21.816572666666616}, {122.0, 10.90905122222216}, {123.0, 10.916064111111154}, 
                                                              {125.0, 21.82837922222234}, {126.0, 10.916064111110927}, {127.0, 10.92293911111119}, {128.0, 10.918217888888876}, {129.0, 10.928355777777597}, 
                                                              {130.0, 10.925161333333335}, {131.0, 10.928773444444687}, {132.0, 10.932244666666747}, {133.0, 10.936272444444285}, {134.0, 10.93606511111102}, 
                                                              };

  int transit_count = 0;
  int max_transit = 135;
  long double last_transit_time = -1;
  long double last_comeT = -1;
  int has_transit = 0;
  int enter_range = 0;
  ...
  while (current_time < target_time) {
    ...
    // Add Transit
    long double posx[bodies.size()];
    long double posy[bodies.size()];
    long double posz[bodies.size()];
    long double transit1;
    long double transit2;
    long double transit3;

    const ld t0 = current_time;
    for (int idx = 1; idx < bodies.size(); idx++)
    {
        auto rvec = GetPos(idx) - GetPos(0);
        posx[idx] = rvec[0];
        posy[idx] = rvec[1];
        posz[idx] = rvec[2];

        if (first_simu == 0){
          init_dist[idx] = sqrt(posx[idx]*posx[idx] + posy[idx]*posy[idx] + posz[idx]*posz[idx]);
        }
    }

    // simulate (h is the step size, gaps is the output gap)
    ...
    first_simu = 1;
    // check the position after one step simulation
    for (int idx = 1; idx < bodies.size(); idx++)
    {
        auto rvec = GetPos(idx) - GetPos(0);
        auto posx2 = rvec[0];
        auto posy2 = rvec[1];
        auto posz2 = rvec[2];
        auto posyz1 = sqrt(posy[idx] * posy[idx] + posz[idx] * posz[idx]);
        auto posyz2 = sqrt(posy2 * posy2 + posz2 * posz2);
        auto posxz1 = sqrt(posx[idx] * posx[idx] + posz[idx] * posz[idx]);
        auto posxz2 = sqrt(posx2 * posx2 + posz2 * posz2);
        auto dist_eachStep = sqrt(posx2 * posx2 + posy2 * posy2 + posz2 * posz2);
        
        //check if planet is ejected 
        if (dist_eachStep >= 10 * init_dist[idx]){
          // transit_output.precision(16);
          // transit_output << idx << " ejected detected" << "\n";
          transit_output.close();
          std::cerr << "Planet ejected."<<"\n";
          remove((sys_dir+"/"+system_name + ".txt").c_str());
          exit(2);
        }

        // check if values of position are Nan 
        if (std::isnan(posx2) || std::isnan(posy2) || std::isnan(posz2)){
          // transit_output.precision(16);
          // transit_output << idx << " nan detected" << "\n";
          transit_output.close();
        ...
        // check transit only within a certain range
        // note that "1.5" is for the situation that planet just end transit, i.e., outside of stellar range
        if (posy2 >= -stellar_radius && posy2 <= 1.5 * stellar_radius && posx2 > 0){
          // if it is non-transit planet transits
          // temp comment
          if (idx == 2 && posyz2 < stellar_radius){
            transit_output.close();
            std::cerr << "notransit transit."<<"\n";
            remove((sys_dir+"/"+system_name + ".txt").c_str());
            exit(2);
          }

          //if it is transit planet
          else if (idx == 1){
            // begin transit, record the time
            if (posyz1 > stellar_radius && posyz2 < stellar_radius){
              transit1 = t0 + h * gaps / (posyz2 - posyz1) * (stellar_radius - posyz1);
              transit_count++;

              if (transit_count > max_transit){ // we have enough transits
                transit_output.close();
                std::cerr << "transit number exceeds:)" <<"\n";
                exit(2);
              }
              last_comeT = transit1;   
              has_transit = 1;        
            }
            // end transit (has_transit here is for avoiding at the very beginning the planet is already transiting)
            else if (posyz1 < stellar_radius && posyz2> stellar_radius && has_transit == 1){
              transit3 = t0 + h * gaps / (posyz2 - posyz1) * (stellar_radius - posyz1);
              // calculate transit time 
              long double temp_transit_time = last_comeT + (transit3 - last_comeT) / 2;

              // if transit epoch in observation compare with obs,
              
                // if >= 2nd transit and has obs data, calculate and compare interval
              if (transit_count >= 2 && obs_ttv_inter.find(transit_count - 1) != obs_ttv_inter.end()){ 
                  
                  long double temp_transit_intv = (temp_transit_time - last_transit_time) * 365.25; // convert to day
                  last_transit_time = temp_transit_time;
                  // save if close to the obs
                  if (fabs(temp_transit_intv - obs_ttv_inter[transit_count-1]) >= 0){ // not have constrain on interval here
                    transit_output.precision(16);
                    // transit_output << idx << " "<< transit_count <<"\n";
                    transit_output << transit_count << " start " << last_comeT << "\n";
                    transit_output << transit_count  << " center " << temp_transit_time <<"\n";
                    transit_output << transit_count  << " end " << transit3 << "\n"; 
                  }
                  else{ // otherwise stop
                    transit_output.close();
                    std::cerr << "Transit interval far from observed. Transit count: " << transit_count << ", transit interv: " << temp_transit_intv <<"\n";
                    remove((sys_dir+"/"+system_name + ".txt").c_str());
                    exit(2);
                  }
                }
                // if 1st transit or the transit not in obs, record start center end time, no need to check interval
              else{
                  transit_output.precision(16);
                  // transit_output << idx << " "<< transit_count <<"\n";
                  transit_output << transit_count  << " start " << last_comeT << "\n";
            ...
            // transit planet enters the range for checking transit
            // i.e., last step is outside the range
            if (posy[idx] < -stellar_radius && posy2 >= -stellar_radius && posx2 > 0){
              enter_range = 1;
            }
            // transit planet leaves the range
            else if (posy2 >= stellar_radius && posy[idx]< stellar_radius && posx2 > 0){
              // check only when the transit planet entered range before
              if (enter_range == 1){
                // if has transit, reset indicators
                if (has_transit == 1){
                  enter_range = 0;
                  has_transit = 0;
                }

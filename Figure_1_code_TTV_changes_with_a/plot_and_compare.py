...
cwd = os.getcwd()
cwd = str(cwd)
Folder_name = "kepler88_obs_2016_para2013_7_19"
...
for file in files:
    cur_parent_path = file #'/num_' + str(i + 1)
    ...
    with open(cur_parent_path + '/file_names.txt', "r") as file_names: # open file_nmaes in num_* folder
        ...
        with ZipFile(cur_parent_path + '/reuslt.zip', 'r') as zip:
            for j, name in enumerate(file_names): # iterate Test
                ...
                try:
                    ...
                    # print(TTV_file_name + ' cannot be loaded/not exist')
                    continue 
                ...
                percent_tdv, tdv_list = get_ttv_duration(transit_data, add_noise)
                ...
                # Test_dic['tdv_list'] = tdv_list #wrt 134
                # Test_dic['dur_coef'] = dur_coef #wrt 134
                # Test_dic['dur_intercept'] = dur_intercept
                Test_dic['name'] = name[0]
                # total_dic[name[0]] = Test_dic
                count += 1

                with open(cwd + '/TTV_files_ttv/kepler88_obs_2016_para2013_7_19_forDiff.pkl', 'ab') as pkl_file:
                    pickle.dump(Test_dic, pkl_file)

        # except:
        #     print(cur_parent_path + ' cannot open zip file.')
        #     continue 
# data = []
# data.append(total_dic)
# file = open(cwd + '/TTV_files_ttv/kepler88_data_1_12.pkl', 'wb')

...
TRAINING_DATA_FILE = '/storage/home/hcoda1/0/cchen672/scratch/TTV_2021_ML_project/Kepler_88/data/kepler88_obs_2016_para2013_Data_3_12_tdv_0.5_average_corrected.pkl' 
...
main_path = '/storage/home/hcoda1/0/cchen672/scratch/TTV_2021_ML_project/Kepler_88/9_train_a_m_e_i_no_tdv' 
...
for i in range(len(preds[0])):
  ...
  if PLOT_FIG == 'mad':
    ...
    if i == 0:
      ax1.set_xscale('log')
      # ax1.axvline(x=1.5, linestyle='--', label='2:3')
      # ax1.axvline(x=4/3, linestyle='--', label='3:4')
      # ax1.axvline(x=2, linestyle='--', label='1:2')
      # ax1.legend(loc='best')
  elif PLOT_FIG == 'hist':
